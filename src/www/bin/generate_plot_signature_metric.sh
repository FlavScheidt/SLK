...
FILE_OUT="${dir}/signature_ranking_metric.gnu"
PDF_OUT="${dir}/signature_ranking_metric.pdf"
IMG_OUT="${dir}/signature_ranking_metric.png"
...
echo "set xrange [-0.5:30.5]" &>> ${FILE_OUT}
echo "set key under autotitle nobox" &>> ${FILE_OUT}

echo "plot '$1' using 0:2:3:xtic(1) with boxerrorbars fc rgb 'forest-green' title '$metric ${2}'" &>> ${FILE_OUT}
